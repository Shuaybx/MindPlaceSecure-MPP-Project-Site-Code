...
Github Code Link:  https://github.com/Shuaybx/MindPlaceSecure-MPP-Project-Site-Code.git
...
How to use
1. Open the site in a browser after installing from github.
...
Deployment
1. The frontend can be deployed to view in Github but be sure to run the setup before testing the site.
2. The signaling server will be hosted separately because it uses long-running WebSocket connections.
3. Updated config.js with the production signaling server URL before deploying.
